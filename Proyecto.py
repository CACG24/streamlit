...
#Semana
  ...
  if opt_MF:
    width = 0.4
    if barY_selected=='Cantidad':
      plt.bar(data_semana['dia_semana'], data_semana['cantidad_H'], width=width, color='blue')
      ...
      plt.bar(data_semana['dia_semana'], data_semana['duracion_H'], width=width, color='blue')
      ...
      plt.bar(data_semana['dia_semana'], data_semana['edad_H'], width=width, color='blue')
      ...
      plt.bar(data_semana['dia_semana'], data_semana['tarifa_H'], width=width, color='blue')
